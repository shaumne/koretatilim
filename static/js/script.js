...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // PDF Download functionality - disabled
    if (downloadPlanBtn) {
        downloadPlanBtn.addEventListener('click', function() {
            console.log("PDF indirme özelliği devre dışı bırakıldı");
        });
    }
    
    // Korean PDF functionality - disabled
    if (koreanPdfBtn) {
        koreanPdfBtn.addEventListener('click', function() {
            console.log("Korece PDF indirme özelliği devre dışı bırakıldı");
        });
    }
    
    // Function disabled
    function generatePDF(isKorean = false) {
        console.log("PDF oluşturma özelliği devre dışı bırakıldı");
        return;
    }
    ...
    if (shareBtn) {
        shareBtn.addEventListener('click', function() {
            console.log("Paylaşma özelliği devre dışı bırakıldı");
        });
    }
    ...
    // Print Plan Button - disabled
    if (printPlanBtn) {
        printPlanBtn.addEventListener('click', function() {
            console.log("Yazdırma özelliği devre dışı bırakıldı");
        });
    }
